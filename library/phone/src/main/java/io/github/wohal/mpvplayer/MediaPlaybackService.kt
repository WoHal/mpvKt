...
class MediaPlaybackService : MediaBrowserServiceCompat(), MPVLib.EventObserver {
  ...
  private fun stopMedia() {
    try {
      ...
      Timber.Forest.e("Error stopping media", e)
    }
  }
  ...
  private fun updateMediaSessionMetadata() {
    try {
      ...
      Timber.Forest.e("Error updating metadata", e)
    }
  }

  private fun updatePlaybackState() {
    Timber.Forest.d("$positionMs / $durationMs")
    try {
      ...
      Timber.Forest.e("Error updating playback state", e)
    }
  }
  ...
  override fun onDestroy() {
    try {
      ...
      Timber.Forest.e("Error in onDestroy", e)
    }
  }
}
